//Abhilasha Sancheti
//sample input : arrowedLine(image , x1 , y1 , x2,y2,r_value,g_value,b_value,thickness,linetype,shift,tiplength)
#include <numeric>
...
extern "C"
{
 ...
 // for B value of colour
    ...
    intErr = geScalarDouble(pvApiCtx, piAddr7,&b_value);
   if(intErr)
          return intErr;
   ...
   // checking linetype
    ...
    {
             linetype=8;
             sciprint("Only 0/4/8 allowed .");
              return 0;
     }   
   //calling the opencv function   
    arrowedLine( src, pt1, pt2, Scalar(r_value,g_value,b_value), thickness, linetype, shift, tiplength);
